...
![Diagrams of three classes of constructs](/img/constructs.png)
...
![Diagram of a complete program consisting of multiple replaceable constructs](/img/structured.png)
...
![Popular symbols for sequence, selection, and iteration constructs](/img/flowChart.png)
...
![Flow charts of the three selection constructs](/img/selection.png)
...
![Flow charts of the three iteration constructs](/img/iteration.png)
