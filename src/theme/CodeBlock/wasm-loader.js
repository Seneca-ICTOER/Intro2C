/*
The majority of this file has been generated by the emscripten toolchain.
There are some slight modifications to adapt it to the project.
*/

export default function WasmLoader(wasmUrl, stdoutStream, stderrStream) {
